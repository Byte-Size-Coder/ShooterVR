...
//     version 1.7.0
//     from Assets/ShooterVR/Samples/XR Interaction Toolkit/2.5.1/Starter Assets/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""MainButton_Left"",
                    ""type"": ""Button"",
                    ""id"": ""74c91e3a-0a2e-46ba-a70b-2f64fb0c8eba"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""dd157e31-eca1-49c9-91d6-944525b180bf"",
                    ""path"": ""<XRController>{LeftHand}/{PrimaryButton}"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""MainButton_Left"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""MainButton_Right"",
                    ""type"": ""Button"",
                    ""id"": ""7cd0a860-2267-46b4-ae2f-6dd026012bd4"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""c16e7f18-1fc6-498d-8960-1467b14d811d"",
                    ""path"": ""<XRController>{RightHand}/{PrimaryButton}"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""MainButton_Right"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_MainButton_Left = m_XRILeftHand.FindAction("MainButton_Left", throwIfNotFound: true);
        // XRI RightHand
    ...
    private readonly InputAction m_XRILeftHand_MainButton_Left;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @MainButton_Left => m_Wrapper.m_XRILeftHand_MainButton_Left;
        ...
        public void AddCallbacks(IXRILeftHandActions instance)
        {
            ...
            @MainButton_Left.started += instance.OnMainButton_Left;
            @MainButton_Left.performed += instance.OnMainButton_Left;
            @MainButton_Left.canceled += instance.OnMainButton_Left;
        }
    ...
    private readonly InputAction m_XRIRightHand_MainButton_Right;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @MainButton_Right => m_Wrapper.m_XRIRightHand_MainButton_Right;
        ...
        public void AddCallbacks(IXRIRightHandActions instance)
        {
            ...
            @Pinch.performed += instance.OnPinch;
            @Pinch.canceled += instance.OnPinch;
            @MainButton_Right.started += instance.OnMainButton_Right;
            @MainButton_Right.performed += instance.OnMainButton_Right;
            @MainButton_Right.canceled += instance.OnMainButton_Right;
        }
    ...
    public interface IXRILeftHandActions
    {
        ...
        void OnMainButton_Left(InputAction.CallbackContext context);
    }
